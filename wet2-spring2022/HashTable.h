...
public:
    ...
    StatusType AddNode(Employee player);
    ...
    StatusType AddPlayer(int playerID, int groupID, int level, int score);

    StatusType DeletePlayer(int playerID);

    Employee GetPlayer(int playerID);
